...
typedef struct OBJ_STRUCT_PACKED_START {
   ...
   UINT32   aEntries[20]; /**< \brief Entry buffer*/
...
#ifdef _EVALBOARD_
 = {20, {0x70100101, 0x70100201, 0x70100301, 0x70100401,0x70100501, 0x70100601, 0x70100701, 0x70100801, 0x70100910,0x70101008,0x70101108,0x70101208,0x70101308,0x70101408,0x70101508,0x70101608,0x70101708,0x70101808,0x70101908,0x70102008}}
#endif
;
/** @}*/
 ...
 * \brief 0x6000 (Digital input object) object and entry names
 */
OBJCONST UCHAR OBJMEM aName0x7010[] = "DO Outputs\000LED 1\000LED 2\000LED 3\000LED 4\000LED 5\000LED 6\000LED 7\000LED 8\000can1_h0\000can1_h1\000can1_h2\000LED 8\000can1_h3\000can1_d0\000can1_d1\000can1_d2\000can1_d3\000can1_d4\000can1_d5\000can1_d6\000can1_d7\000\000\377";
#endif //#ifdef _OBJD_
...
#ifdef _EVALBOARD_
= {20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
#endif
;
/** @}*/
...
TOBJECT    OBJMEM ApplicationObjDic[] = {
   ...
   /* Object 0x1601 */
   {NULL,NULL,  0x1601, {DEFTYPE_PDOMAPPING, 20 | (OBJCODE_REC << 8)}, asEntryDesc0x1601, aName0x1601, &sDORxPDOMap, NULL, NULL, 0x0000 },
   /* Object 0x1802 */
   ...
   /* Object 0x7010 */
   {NULL,NULL,   0x7010, {DEFTYPE_RECORD, 20 | (OBJCODE_REC << 8)}, asEntryDesc0x7010, aName0x7010, &sDOOutputs, NULL, NULL, 0x0000 },
    /* Object 0x8020 */
